...
if [[ $install == true ]]; then
  bash <(curl -s https://raw.githubusercontent.com/Jakob434/Fiveminstaller/main/install.sh) $runtime_link
else
  bash <(curl -s https://raw.githubusercontent.com/Jakob434/Fiveminstaller/main/update.sh) $runtime_link
fi
